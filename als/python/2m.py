...
print "Setting up..."
os.system("head -n 2000001 ratings.csv > ratings_.csv; rm ratings.csv; mv ratings_.csv ratings.csv")
...
# Set up in 0:00:03.174252
# Training in 0:00:15.198464
# Predicting in 0:30:45.644360
# Reccing in 0:02:12.443556
# Total: 0:33:16.460632
