...
learner() {
  vw --total $cores --node $1 --unique_id 0 --span_server localhost --holdout_off -d "als/data/$2_0$1" -f "als/data/model.$1" --cache_file "als/data/cachefile.$1" --passes 10 -b 18 -q ui --rank 10 --l2 0.01 --learning_rate 0.015 --decay_learning_rate 0.97 --power_t 0
}
predictor() {
