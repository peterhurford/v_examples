...
# Convert ratings from movielens format to VW format (14s)
...
# Train a VW ALS model on the data (24s)
...
split -d -l 8599 users_t.dat users  # 34395 users into 4 splits
split -d -l 6820 movies_t.dat movies   # 27278 movies into 4 splits
split -d -l 1250000 ratings_t.dat ratings # 5000000 ratings into 4 splits
...
# Turn predictions into top 10 recs per user (10m3s)
generate_recs() {
